...
public class MulticubeChunkLoaderCommand implements CommandExecutor {
    ...
    public MulticubeChunkLoaderCommand(MulticubeChunkLoader plugin) {
        ...
        commands.add(new Command("", "/acl - Gives an activator that is used to right click a block to place a chunk loader, or right click an existing chunk loader to edit.", "multicubechunkloader.place"));
        commands.add(new Command("place", "/acl place - Opens the place chunk loader menu", "multicubechunkloader.place"));
        commands.add(new Command("balance", "/acl balance - Prints your chunk loader balance,", "multicubechunkloader.balance"));
        commands.add(new Command("list", "/acl list [page #] - Lists all chunk loaders.", "multicubechunkloader.list"));
        commands.add(new Command("delete", "/acl delete <#|all> - Deletes specified or all chunk loaders", "multicubechunkloader.delete"));
