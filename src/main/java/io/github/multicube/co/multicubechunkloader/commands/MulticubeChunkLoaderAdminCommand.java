package io.github.multicube.co.multicubechunkloader.commands;
...
import io.github.multicube.co.multicubechunkloader.util.StringUtils;
import io.github.multicube.co.multicubechunkloader.util.UUIDUtils;
...
public class MulticubeChunkLoaderAdminCommand implements CommandExecutor {
    ...
    public MulticubeChunkLoaderAdminCommand(MulticubeChunkLoader plugin) {
        ...
        commands.add(new Command("add", "/acla add <owner> <personal|world> <# chunks> - Adds available chunks of the given type to players balance. This can be a negative number.", "multicubechunkloader.admin.add"));
        commands.add(new Command("balance", "/acla list <player> - Lists the balance of the specified player.", "multicubechunkloader.admin.balance"));
        commands.add(new Command("list", "/acla list [owner:<owner>] [world:<world>] [type:<personal|world|creative>] [page #] - Lists all chunk loaders.", "multicubechunkloader.admin.list"));
        commands.add(new Command("delete", "/acla delete <id:id|owner:owner|world:world|all> - Deletes specified or all chunk loaders", "multicubechunkloader.admin.delete"));
        commands.add(new Command("reload", "/acla reload - Reloads the plugin, including configuration and loaded chunks", "multicubechunkloader.admin.reload"));
    }
